  ...
  return <>
    ...
    >
      ...
      <DialogActions>
        ...
        <Button onClick={overwriteFile} autoFocus>Continue</Button>
      </DialogActions>
    </Dialog>
    ...
    >
      <DialogTitle id="no-discept">
        {"Valid TEI But..."}
      </DialogTitle>
      <DialogContent>
        <DialogContentText id="no-discept-desc">
          The uploaded file does not look like a DiSCePT TEI model. Do you want to import it as a language instead?
        </DialogContentText>
        <TextField
          autoFocus
          required
