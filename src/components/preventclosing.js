...
import { save } from "../autosave.js";    // for autosaving
...
export default function PreventClosing() {
  ...
  window.onbeforeunload = () => {
    save();         // saving for autosave
    data.isChanged; // Returns `true` if there are unsaved changes, triggering the browser's unload confirmation dialog.
  } 
